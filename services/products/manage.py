...
def seed_db():
    ...
    db.session.add(Product(name='Oreo', 
    stock=20, price=0.7, trademark="Nabisco", category="Galletas"))
    db.session.add(Product(name='Picaras Fresa', 
    stock=25, price=0.8, trademark="Costa", category="Galletas"))
    db.session.commit()
